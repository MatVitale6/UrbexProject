...
public class AuthConfiguration {
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .requestMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**","/js/**","/formSearchPlaces","favicon.ico", "/place/**", "/places", "/place").permitAll()
        .requestMatchers(HttpMethod.POST, "/login", "/register", "/place/**", "/searchPlacesByRegion","/searchPlacesByAddress").permitAll()
